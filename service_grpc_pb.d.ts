...
interface ICompanyServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  readCompanies: grpc.MethodDefinition<service_pb.Pagination, service_pb.CompanyAllResponse>;
...
export class CompanyServiceClient extends grpc.Client {
  ...
  readCompanies(argument: service_pb.Pagination, callback: grpc.requestCallback<service_pb.CompanyAllResponse>): grpc.ClientUnaryCall;
  readCompanies(argument: service_pb.Pagination, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<service_pb.CompanyAllResponse>): grpc.ClientUnaryCall;
  readCompanies(argument: service_pb.Pagination, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<service_pb.CompanyAllResponse>): grpc.ClientUnaryCall;
